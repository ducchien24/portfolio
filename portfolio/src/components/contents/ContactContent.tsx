                    ...
                    <div className="container">
                        <div className="leftbox">
                            ...
                            <div className="short_info_wrap">
                                <ul>
                                    <li><p><label>{t('Address')}:</label><span>Q.Tân Bình, Hồ Chí Minh</span></p></li>
                                    <li><p><label>{t('Email')}:</label><span><a href="mailto:chien24022001a@gmail.com">chien24022001a@gmail.com</a></span></p></li>
                                    <li><p><label>{t('Website')}:</label><span><a href="mailto:example@gmail.com">www.yourdomain.com</a></span></p></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="arlo_tm_contact_wrap">
                                <div className="main_input_wrap">
                                    <form ref={form} onSubmit={sendEmail}  className="contact_form" id="contact_form">
                                        ...
                                        <div className="empty_notice"><span>{t('Please Fill Required Fields')}</span></div>
                                        <div className="wrap">
                                            <input id="name" type="text" name="from_name" placeholder={t('Your Name')} />
                                        </div>
                                        <div className="wrap">
                                            <input id="email" type="text" name="from_email" placeholder={t('Your Email')} />
                                        </div>
                                        <div className="wrap">
                                            <textarea id="message" placeholder={t("Your Message")}  name="message"></textarea>
                                        </div>
                                        <div className="arlo_tm_button">
                                        <input type="submit" id="send_message" value={t("Send Message" )} />
